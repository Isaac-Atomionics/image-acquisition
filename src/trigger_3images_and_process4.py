...
savepath = 'C:/Users/admin/Desktop/camera_stuff/images/Abs_imaging-2020-12-15/'
           ...
           #     OD = np.log(np.divide(img_las,img_at))
            ...
            #    with np.printoptions(threshold=np.inf):
               ...
               # plt.clim(0,1) # colourbar limit (,)
                ...
                headline = ['Run #', 'filename','sigma_x','sigma_z','TOF','N','I/Is','sigma_x fit error','sigma_z fit error']
                ...
                with open(savepath + folder_date + '-Data00000.csv', 'r') as file:
                    ...
                    rows = list(reader)
                    line_num = len(rows)
                parameters = [line_num,filename, sigma_x,sigma_z,tof,N_at,IoverIs,err_x,err_z]
